...
const schedule_validator_1 = require("../middlewares/schedule.validator");
/**
 * @swagger
 * components:
 *   schemas:
 ...
 */
router.post("/", schedule_validator_1.validateSchedule, schedule_controller_1.createSchedule);
/**
 * @swagger
 * /api/schedules:
 *   get:
 ...
 */
router.get("/doctor/:doctorId", schedule_controller_1.getDoctorSchedules);
/**
 * @swagger
 * /api/schedules/{id}:
 *   get:
 ...
 */
router.put("/:id", schedule_validator_1.validateSchedule, schedule_controller_1.updateSchedule);
/**
 * @swagger
 * /api/schedules/{id}:
 *   delete:
