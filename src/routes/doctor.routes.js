...
const doctor_validator_1 = require("../middlewares/doctor.validator");
 ...
 *         description: Server error
 */
router.get("/me", doctor_controller_1.getDoctorProfile);
/**
 * @swagger
 * /doctors/me:
 *   post:
 ...
 *         description: Server error
 */
router.post("/me", doctor_validator_1.validateDoctorProfile, doctor_controller_1.createDoctorProfile);
/**
 * @swagger
 * /doctors/me:
 *   patch:
 ...
 *         description: Server error
 */
router.patch("/me", doctor_validator_1.validateDoctorProfileUpdate, doctor_controller_1.updateDoctorProfile);
/**
 * @swagger
 * /doctors/me:
 *   delete:
 ...
 *         description: Server error
 */
router.delete("/me", doctor_controller_1.deleteDoctorProfile);
/**
 * @swagger
 * /doctors/{doctorId}:
 *   get:
 ...
 *         description: Server error
 */
router.get("/:doctorId", doctor_controller_1.getDoctorProfileById);
